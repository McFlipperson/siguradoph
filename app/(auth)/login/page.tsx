    ...
    >
      ...
      */}
      <div className="absolute left-[3.5%] right-[3.5%] top-[6%] rounded-3xl bg-white px-5 pt-5 pb-4 flex flex-col gap-3 shadow-sm">
        ...
        {confirmationFailed && (
          <div className="rounded-xl bg-red-50 border border-red-200 px-4 py-2 text-xs text-red-700 text-center font-medium">
        ...
        <div className="flex justify-center pt-1">
          {/* swap for <Image> if you have a logo asset */}
          <span className="text-2xl font-black tracking-tight">
            <span className="text-blue-600">S</span>
            <span className="text-gray-900">igurado</span>
