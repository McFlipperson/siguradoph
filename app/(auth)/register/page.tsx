      ...
      <div className="relative z-10 min-h-screen flex flex-col px-5 pt-10 pb-0">
        <div className="bg-white rounded-[2rem] shadow-2xl px-7 pt-8 pb-7 flex flex-col gap-4">
          ...
          <div className="text-center">
            <h1 className="text-[1.75rem] font-black text-gray-900 leading-tight">Create your account</h1>
            <p className="text-sm text-gray-500 mt-1">You&apos;ll set up your clinic right after this.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input type={showPass ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} placeholder="At least 8 characters" required autoComplete="new-password"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input type={showConf ? 'text' : 'password'} value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="••••••••" required autoComplete="new-password"
                  className="w-full pl-12 pr-12 h-14 rounded-2xl border-2 border-gray-100 bg-gray-50 text-sm focus:outline-none focus:border-blue-400 transition-colors" />
                <button type="button" onClick={() => setShowConf(v => !v)} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400">
