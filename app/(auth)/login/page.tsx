...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#dbeafe]">
      ...
      {/* Full-screen background image — save your mockup to public/images/login-image.png */}
      <Image
      ...
      <div className="relative z-10 min-h-screen flex flex-col px-5 pt-10 pb-0">
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl px-7 pt-8 pb-7 flex flex-col gap-4">
          ...
          <div className="flex justify-center">
            <Image src="/images/sig-final-ph-logo.png" alt="Sigurado" width={180} height={54} className="object-contain" />
          </div>

          {/* Heading */}
          <div className="text-center">
            <h1 className="text-[1.75rem] font-black text-gray-900 leading-tight">Welcome back!</h1>
            <p className="text-sm text-gray-500 mt-1">Log in to continue managing your clinic with ease.</p>
          </div>

          {confirmationFailed && (
            <div className="rounded-2xl bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700 text-center">
              The confirmation link has expired. Please register again or contact support.
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  autoComplete="email"
                  className="w-full pl-12 pr-4 h-14 rounded-2xl border-2 border-gray-100 bg-gray-50 text-sm focus:outline-none focus:border-blue-400 transition-colors"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 h-14 rounded-2xl border-2 border-gray-100 bg-gray-50 text-sm focus:outline-none focus:border-blue-400 transition-colors"
                />
                <button
                  type="button"
            ...
            {resetSent && (
              <p className="text-sm text-green-700 bg-green-50 border border-green-200 rounded-2xl px-4 py-3 text-center">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-14 rounded-2xl bg-blue-600 text-white font-bold text-lg shadow-lg shadow-blue-200 active:scale-[0.98] transition-transform disabled:opacity-60 mt-1"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="h-14 rounded-2xl border-2 border-gray-100 bg-gray-50 flex items-center justify-center gap-2 font-semibold text-sm text-gray-700 active:bg-gray-100 transition-colors disabled:opacity-60"
            >
              {oauthLoading === 'google' ? '…' : (
                <>
          ...
          <div className="flex items-center gap-3 rounded-2xl bg-blue-50 border border-blue-100 px-4 py-3">
            ...
            <div>
              <p className="font-bold text-sm text-blue-900">Your clinic. Your data.</p>
              <p className="text-xs text-blue-700">Secure, private, and always protected.</p>
            </div>
          </div>
        </div>

        {/* Sign up link — sits below card, shows over image (doctors visible behind) */}
        <p className="text-center text-sm font-medium text-gray-800 mt-5 pb-8">
          Don&apos;t have an account?{' '}
          <Link href="/register" className="text-blue-700 font-bold underline underline-offset-2">
            Sign up
          </Link>
        </p>
      </div>
