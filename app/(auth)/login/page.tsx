...
function LoginForm() {
  ...
  return (
    ...
    >
      {/* ── White card overlay ──────────────────────────────────────────
          TWEAK: `top` moves the card up/down on the image.
          TWEAK: `mx` (left/right padding on parent) widens/narrows it.
          Target: card sits over the white rounded-rectangle in the image.
      ────────────────────────────────────────────────────────────────── */}
      <div className="absolute inset-x-0" style={{ top: '7vh', paddingLeft: '4.5%', paddingRight: '4.5%' }}>
        <div className="w-full rounded-3xl bg-white shadow-xl px-6 pt-6 pb-5">

          {confirmationFailed && (
            <div className="mb-3 rounded-xl bg-red-50 border border-red-200 px-4 py-2 text-xs text-red-700 text-center font-medium">
          ...
          <div className="flex justify-center mb-1">
            {/* Replace with <Image> if you have an actual logo asset */}
            <span className="text-2xl font-black tracking-tight">
              <span className="text-blue-600">S</span>
              <span className="text-gray-800">igurado</span>
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-xs text-gray-500 mt-0.5">Log in to continue managing your clinic with ease.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-9 pr-3 rounded-xl border border-gray-200 bg-white text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-200 transition-colors"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-9 pr-10 rounded-xl border border-gray-200 bg-white text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-200 transition-colors"
                />
            ...
            {resetSent && <p className="text-xs text-green-700 font-semibold text-center bg-green-50 rounded-lg px-2 py-1">Reset email sent! Check your inbox.</p>}
            ...
            <button type="submit" disabled={loading}
              className="w-full h-12 rounded-xl bg-blue-600 text-white font-bold text-sm active:scale-[0.98] transition-transform disabled:opacity-60">
            ...
            <div className="grid grid-cols-2 gap-2">
              {(['google', 'apple'] as const).map(p => (
                <button key={p} type="button" onClick={() => handleOAuth(p)} disabled={oauthLoading !== null}
                  className="h-12 rounded-xl bg-white border border-gray-200 flex items-center justify-center gap-1.5 font-semibold text-xs text-gray-700 active:bg-gray-50 disabled:opacity-60 shadow-sm">
          ...
          <p className="text-center text-xs font-medium text-gray-500 mt-4">
            ...
            <Link href="/register" className="text-blue-600 font-bold">Sign up</Link>
          </p>

        </div>

        {/* RA 10173 footer — sits below card, over the characters area */}
